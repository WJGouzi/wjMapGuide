...
#define BGCOLOR [UIColor colorWithRed:244/255.0 green:244/255.0 blue:244/255.0 alpha:1]
...
- (void)viewDidLoad {
    ...
    UIImageView *searchBg = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"citySearchBg"]];
...
- (void)setNavigationWithTitle:(NSString *)title {
    ...
    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 64, screenW, 0.5)];
    line.backgroundColor = [UIColor colorWithRed:186/255.0f green:186/255.0f blue:186/255.0f alpha:1.0f];
